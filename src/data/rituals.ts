...
const rituals: Array<Ritual> = [
  {
    ...
    description: '<p>Você vislumbra seu futuro próximo, analisando milhões de possibilidades e escolhendo a melhor. Você recebe +15 em um teste de resistência ou na Defesa contra um ataque.</p><p><strong>Verdadeiro (+5 PE):</strong> muda o alcance para “curto” e o alvo para “um aliado à sua escolha”.</p>'
  },
  {
  ...
  },
  {
    ...
    duration: 'cena',
    description: '<p>Você imbui o alvo com Energia, fazendo-o funcionar acima de sua capacidade. O item recebe uma modificação a sua escolha.</p><p><strong>Discente (+2 PE):</strong> muda para duas modificações. Requer 2º círculo.</p><p><strong>Verdadeiro (+5 PE):</strong> muda para três modificações. Requer 3º círculo e afinidade.</p>'
  },
  {
  ...
  },
  {
    ...
    target: '1 ser',
    duration: 'cena',
    description: '<p>O alvo tem seus músculos tonificados e seus ligamentos reforçados, recebendo +1 em Agilidade ou Força, à escolha dele.</p><p><strong>Discente (+3 PE):</strong> muda o bônus para +2. Requer 3º círculo.</p><p><strong>Verdadeiro (+7 PE):</strong> muda o bônus para +3. Requer 4º círculo e afinidade.</p>'
  },
  {
  ...
  },
  {
    ...
    target: '1 ser',
    duration: 'cena',
    description: '<p>Espirais surgem no corpo do alvo, tornando seus movimentos lentos. O alvo sofre –1d20 em testes de ataque.</p><p><strong>Discente (+2 PE):</strong> muda a penalidade para –2d20. Requer 2º círculo.</p><p><strong>Verdadeiro (+8 PE):</strong> muda a penalidade para -2d20. e o alvo para “seres escolhidos”. Requer 3º círculo.</p>'
  },
  {
    name: 'Ferver Sangue',
    circle: '3',
